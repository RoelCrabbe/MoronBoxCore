...
function mb_createMacros()
    ...
    CreateMacro("01Setup", 487, "/script mb_setup()", 1, 1)
    CreateMacro("02Single", 121, "/script mb_single()", 1, 1)
    CreateMacro("03Multi", 155, "/script mb_multi()", 1, 1)
    CreateMacro("04Cooldowns", 21, "/script mb_cooldowns()", 1, 1)
    CreateMacro("05AOE", 206, "/script mb_AOE()", 1, 1)
    CreateMacro("06Mount", 90, "/script mb_mountUp()", 1, 1)
    CreateMacro("07InviteSum", 63, "/script mb_requestInviteSummon()", 1, 1)
    CreateMacro("08PWStanksCCPull", 394, "/script mb_crowdControlAsPull()", 1, 1)
    CreateMacro("09FocusME", 471, "/script mb_setFocus()", 1, 1)
    CreateMacro("10AssignOT", 22, "/script mb_assignOffTank()", 1, 1)
    CreateMacro("11AssignCC", 394, "/script mb_assignCrowdControl()", 1, 1)
    CreateMacro("12ClearAssign", 492, "/script mb_clearRaidTarget()", 1, 1)
    CreateMacro("13MakeWater", 339, "/script mb_makeWater()", 1, 1)
    CreateMacro("14DrinkWater", 339, "/script mb_smartDrink()", 1, 1)
    CreateMacro("15BreakFear", 489, "/script mb_fearBreak()", 1, 1)
    CreateMacro("16Follow", 129, "/script mb_followFocus()", 1, 1)
    CreateMacro("17Totems", 432, "/script mb_dropTotems()", 1, 1)
    CreateMacro("18Ress", 303, "/script mb_ress()", 1, 1)
