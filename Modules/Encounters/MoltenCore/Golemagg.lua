-- [[ Golemagg Bossing Logic ]] --

-- Bossname
local BOSS_KEY = "Golemagg"
...
-- Initalize
MoronBox.Core.Bosses.Golemagg = MoronBox.Core.Bosses.Golemagg or {}
...
MoronBox:RegisterModule(MODULE_NAME, function()
    ...
    getBosses().Register(ENCOUNTER_KEY, {
        boss        = { "Golemagg" },
        guardians   = { "Core Ranger" },
        onEngage    = function() getApi().CdRaidWarning(">> Fighting Golemagg <<") end,
        onDisengage = function() getApi().CdRaidWarning(">> Golemagg Defeated <<") end,
        onActive    = function()
            if FirePotsStrategy and (getCore().ImTank() or getCore().ImMeleeDPS()) then
...
function MoronBox.Core.Bosses.Golemagg.TargetingPostFocus()
