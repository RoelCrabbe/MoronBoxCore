-- [[ Ragnaros Bossing Logic ]] --

-- Bossname
local BOSS_KEY = "Ragnaros"
...
-- Initalize
MoronBox.Core.Bosses.Ragnaros = MoronBox.Core.Bosses.Ragnaros or {}
...
MoronBox:RegisterModule(MODULE_NAME, function()
    ...
    getBosses().Register(ENCOUNTER_KEY, {
        boss        = { "Ragnaros" },
        onEngage    = function() getApi().CdRaidWarning(">> Fighting Ragnaros <<") end,
        onDisengage = function() getApi().CdRaidWarning(">> Ragnaros Defeated <<") end,
        onActive    = function()
...
function MoronBox.Core.Bosses.Ragnaros.TargetingPostFocus()
